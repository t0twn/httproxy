...
basic_auth = WhiteListBasicAuth(APP)
...
def set_cors_headers(response_headers, request_headers):
    ...
    if "Access-Control-Request-Header" in request_headers:
        response_headers["Access-Control-Allow-Headers"] = request_headers["Access-Control-Request-Header"]
